...
const Banner = ({netflixOriginals}:BannerProps) => {
    ...
    useEffect(()=> {
        // generate a random movie everytime the page refreshes
    ...
    return (
        <div className="flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[65vh] lg:justify-end lg:pb-12">
            ...
            <div className="flex space-x-3">
                ...
                <button className="bannerButton bg-[gray]/70">More Info<InformationCircleIcon className="h-5 w-6 md:h-8 md:w-8"/></button>
            </div>
        </div>
    );
}
